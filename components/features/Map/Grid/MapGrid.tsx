...
export function MapGrid({
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-[#0c0c0c] p-4">
      <div className="grid h-full w-full grid-cols-10 gap-2 overflow-auto p-4 md:grid-cols-12 lg:grid-cols-15">
        {locations.map((loc) => (
          <Button
            key={loc.id}
            variant="ghost"
