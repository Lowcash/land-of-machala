...
export function GameDashboard({ character }: GameDashboardProps) {
  ...
  const viewData = {
    ...
    armory: {
      bg: '/assets/armory-background.jpg',
      title: 'Zbrojíř',
      icon: Store,
    ...
    healer: {
      bg: '/assets/healer-background.jpg',
      title: 'Léčitel',
      icon: Cross,
    ...
    plains: {
      bg: '/assets/plains-background.jpg',
      title: 'Zelené pláně',
      icon: Trees,
    ...
    desert: {
      bg: '/assets/desert-background.jpg',
