            ...
            {showSettings && (
              <div className="relative" ref={settingsRef}>
                <button
                  ...
                  className="rounded border border-[#8b6f47] bg-black/60 p-2 transition-colors hover:border-[#ffd700]"
                >
                    ...
                    {customMenuItems || (
                      <>
                        ...
                        <button
                          ...
                          className="flex w-full items-center gap-2 px-3 py-2 text-sm text-[#ff6b6b] hover:bg-black/60"
                        >
