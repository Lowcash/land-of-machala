...
export function CharacterDetailContent({
  ...
  return (
    <div className="flex flex-col h-full rounded-lg border-2 border-[#d4a574] bg-linear-to-br from-black/80 to-black/60 shadow-lg p-3">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex items-center justify-between rounded border border-[#8b6f47]/30 bg-black/40 px-2 py-1">
              ...
              <span className="text-xs font-bold text-[#d4a574]" style={{ fontFamily: 'var(--font-fantasy)' }}>
                {character.physicalResistance}%
              </span>
            </div>
            <div className="flex items-center justify-between rounded border border-[#8b6f47]/30 bg-black/40 px-2 py-1">
              <span className="text-[10px] text-[#8b7355]">Magická</span>
              <span className="text-xs font-bold text-[#b66bd4]" style={{ fontFamily: 'var(--font-fantasy)' }}>
                {character.magicalResistance}%
              </span>
            </div>
            <div className="flex items-center justify-between rounded border border-[#8b6f47]/30 bg-black/40 px-2 py-1">
              <span className="text-[10px] text-[#8b7355]">Oheň</span>
              <span className="text-xs font-bold text-[#ff6b6b]" style={{ fontFamily: 'var(--font-fantasy)' }}>
                {character.fireResistance}%
              </span>
            </div>
            <div className="flex items-center justify-between rounded border border-[#8b6f47]/30 bg-black/40 px-2 py-1">
              <span className="text-[10px] text-[#8b7355]">Chlad</span>
              <span className="text-xs font-bold text-[#69ccf0]" style={{ fontFamily: 'var(--font-fantasy)' }}>
                {character.coldResistance}%
              </span>
            </div>
            <div className="flex items-center justify-between rounded border border-[#8b6f47]/30 bg-black/40 px-2 py-1 col-span-2">
              <span className="text-[10px] text-[#8b7355]">Jed</span>
              <span className="text-xs font-bold text-[#6fbf6f]" style={{ fontFamily: 'var(--font-fantasy)' }}>
