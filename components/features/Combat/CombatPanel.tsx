...
export function CombatPanel() {
  ...
  const handleUsePotion = (itemId: number) => {
    ...
    if (potion.healing) {
      setPlayerHp((prev) => Math.min(100, prev + potion.healing!))
      setCombatLog((prev) => [
    ...
    if (potion.mana) {
      setPlayerMana((prev) => Math.min(100, prev + potion.mana!))
      setCombatLog((prev) => [
