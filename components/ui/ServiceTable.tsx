            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                {columns.map((col, colIdx) => (
                  <div key={col.key}>
                    {colIdx === 0 ? (
                      <div className="text-sm text-[#f5e6d3]">{col.render ? col.render(item) : item[col.key]}</div>
                    ) : (
                      <div className="text-[10px] text-[#8b7355]">{col.render ? col.render(item) : item[col.key]}</div>
                    )}
                  </div>
                ))}
              </div>
