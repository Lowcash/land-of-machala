...
export const playerSignSchema = z.object({
  email: z.string({ required_error: i18n.t('sign.email_required') }),
  password: z.string({ required_error: i18n.t('sign.password_required') }),
})

export type PlayerSignSchema = z.infer<typeof playerSignSchema>

export const playerCreateSchema = z.object({
  name: z.string({ required_error: i18n.t('sign.name_required') }),
  raceId: z.string({ required_error: i18n.t('sign.race_required') }),
  classId: z.string({ required_error: i18n.t('sign.class_required') }),
})
