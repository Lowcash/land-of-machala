...
export type RootStageFrameAs = 'div' | 'footer' | 'header' | 'main' | 'section'
export type RootStageFramePreset = 'center' | 'split'
...
const ROOT_STAGE_FRAME_PRESET_CLASS: Record<RootStageFramePreset, string> = {
  split: 'grid flex-1 items-start gap-(--gap-section) lg:grid-cols-2 lg:items-center',
