...
export const stackVariants = cva('', {
  variants: {
    ...
    position: { relative: 'relative', absolute: 'absolute', static: 'static' },
    inset: { none: '', xs: '-right-1 -bottom-1', base: '-right-2 -bottom-2' },
...
export const Stack = React.forwardRef<HTMLElement, StackProps>(
  ({ as: Component = 'div', sm, md, lg, xl, ...props }, ref) => {
    ...
    const keys = ['display', 'direction', 'cols', 'align', 'justify', 'gap', 'fullWidth', 'fullHeight', 'wrap', 'p', 'pt', 'pb', 'px', 'py', 'flex', 'maxWidth', 'mx', 'minHeight', 'minWidth', 'height', 'width', 'position', 'inset', 'rounded', 'border', 'borderColor', 'bgColor', 'overflow', 'shadow']
    keys.forEach(key => {
