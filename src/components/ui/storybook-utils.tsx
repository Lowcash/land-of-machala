 ...
 */
export function StoryContainer({ children, width = 'md', height, p = 'xl' }: StoryContainerProps) {
  return (
    <VStack align="stretch" justify="center" p={p} gap="md" fullWidth maxWidth={width} height={height}>
      {children}
    </VStack>
  )
}
